...
class LanguageHelper {
  ...
  Future<void> initial({
    ...
    /// This is the list of `key` and only use for analysis purposes, it will be
    /// used by [analyze] method. Usually is the data generated by [language_helper_generator](https://pub.dev/packages/language_helper_generator).
